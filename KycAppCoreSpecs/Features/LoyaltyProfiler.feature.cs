...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Layoality Profile evaluates to five when registration happened exactly 366 days a" +
            "go")]
        public virtual void LayoalityProfileEvaluatesToFiveWhenRegistrationHappenedExactly366DaysAgo()
        {
            string[] tagsOfScenario = ((string[])(null));
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Layoality Profile evaluates to five when registration happened exactly 366 days a" +
                    "go", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 16
this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);
...
#line hidden
        ...
        public virtual void LayoalityProfilePointsAreEvaluatingTo5X2WhenRegistrationHappendedLongerThan365Days(string daysPassedSinceSignUp, string moneySpent, string daysAgo, string expectedLoyaltyPoints, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Layoality Profile points are evaluating to 5 + X * 2 when registration happended " +
                    "longer than 365 days", "          and purchases with the amount of X were made within the last 30 days", tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 27
this.ScenarioInitialize(scenarioInfo);
#line hidden
            bool isScenarioIgnored = default(bool);
